...
class feature_extractor(nn.Module):
    ...
    def __init__(self, length, type, out_dim):
        ...
        self.conv3 = nn.Conv1d(8, 16, kernel_size=5, stride=2, padding=2)
        self.bn3 = nn.BatchNorm1d(16)
        self.dropout3 = nn.Dropout(0.3)
        self.conv4 = nn.Conv1d(16, 30, kernel_size=5, stride=3, padding=2)
        self.bn4 = nn.BatchNorm1d(30)
        self.dropout4 = nn.Dropout(0.3)
        self.conv5 = nn.Conv1d(30, 60, kernel_size=5, stride=3, padding=1)
        self.bn5 = nn.BatchNorm1d(60)
        self.dropout5 = nn.Dropout(0.3)

        # TODO: more sophisticated network required
        self.final_l = 300 #16*int(length/8)
